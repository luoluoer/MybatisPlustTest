 ...
 * 
 * */
@Service("JnkgServiceImpl")
public class JnkgServiceImpl implements MineInfoService {
	@Autowired
	MineInfoMapper mim;
	@Resource
	RestTemplate  resttemplate;
	String baseurl = "https://dzzb.jnkgjtdzzbgs.com/cms/channel/1ywgg1qb/index.htm";
